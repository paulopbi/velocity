...
function Features() {
	return (
		<section className="py-20 bg-section/30" id="features">
			<div className="container mx-auto">
				{/* header */}
				<div className="text-center space-y-2">
					<h2 className="text-4xl font-bold">Everything you need to succeed</h2>
					<p className="text-xl text-muted-foreground max-w-[40ch] text-pretty mx-auto">
						Powerful features to help your team work smarter, not harder
					</p>
				</div>

				{/* cards */}
				<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 justify-center my-10">
